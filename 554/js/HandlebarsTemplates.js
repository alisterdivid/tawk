	...
	compiler: [6, ">= 2.0.0-beta.1"], main: function (a, c, d, b) {
		...
		return '<div style="margin-top : 10px;">' +
			e((c.I18n || a && a.I18n || d).call(a, "live_answering_introduction", {
				...
				hash: {context: "admin"},
				data: b
			})) + '</b></h5><div id="liveAnswering-details-container"><div class="details-wrapper"><div class="details-image-wrapper"><img src="https://static-a.VOOChat/v2/a34/images/hireagent-price.png"/></div><div>' + e((c.I18n || a &&
				...
				data: b
			})) + '</div></div><div class="details-wrapper"><div class="details-image-wrapper"><img src="https://static-a.VOOChat/v2/a34/images/hireagent-247.png" /></div><div>' + e((c.I18n || a && a.I18n || d).call(a, "live_answering_details_24_7_365", {
				name: "I18n", hash: {
					variables: '{"lineStart" : "<p>", "lineEnd" : "</p>", "bigTextStart" : "<b>", "bigTextEnd" : "</b>"}',
					context: "admin"
				}, data: b
			})) + '</div></div><div class="details-wrapper"><div class="details-image-wrapper"><img src="https://static-a.VOOChat/v2/a34/images/hireagent-real.png" /></div><div>' + e((c.I18n || a && a.I18n || d).call(a, "live_answering_details_real_humans", {
				name: "I18n",
				hash: {
					variables: '{"lineStart" : "<p>", "lineEnd" : "</p>", "bigTextStart" : "<b>", "bigTextEnd" : "</b>"}',
					context: "admin"
				...
				data: b
			})) + '</div></div><div class="details-wrapper"><div class="details-image-wrapper"><img src="https://static-a.VOOChat/v2/a34/images/hireagent-conversion.png" /></div><div>' +
			e((c.I18n || a && a.I18n || d).call(a, "live_answering_details_better_leads", {
				...
				data: b
			})) + '</div></div><div class="details-wrapper"><div class="details-image-wrapper"><img src="https://static-a.VOOChat/v2/a34/images/hireagent-crm.png" /></div><div>' + e((c.I18n || a && a.I18n || d).call(a, "live_answering_details_crm_integration", {
				name: "I18n", hash: {
					variables: '{"lineStart" : "<p>", "lineEnd" : "</p>", "bigTextStart" : "<b>", "bigTextEnd" : "</b>"}',
					context: "admin"
				}, data: b
			})) + '</div></div><div class="details-wrapper"><div class="details-image-wrapper"><img src="https://static-a.VOOChat/v2/a34/images/hireagent-multilanguage.png" /></div><div>' + e((c.I18n || a && a.I18n || d).call(a, "live_answering_details_native_speakers", {
				name: "I18n",
				hash: {
					variables: '{"lineStart" : "<p>", "lineEnd" : "</p>", "bigTextStart" : "<b>", "bigTextEnd" : "</b>"}',
					context: "admin"
				...
				name: "I18n", hash: {
					variables: '{"lineStart" : "<p>", "lineEnd" : "</p>", "questionStart" : "<h4>", "questionEnd" : "</h4>", "link" : "<a href=\'mailto:support@VOOChat\'>support@VOOChat</a>"}',
					context: "admin"
				}, data: b
			})) + "</li></ol></div>"
	}, useData: !0
	...
	1: function (a, c, d, b) {
		...
		return '<div id="min-whitelabel-settings" class="smart-form"><div class="edit-container" style="float : left; width : 100%;"><div style="margin-right : 330px; position: relative;"><div style="margin : 0; "><h5>' + e((c.I18n || a && a.I18n || d).call(a, "widget_footer_branding", {
			...
			e((c.I18n || a && a.I18n || d).call(a, "title", {
				...
				hash: {context: "admin"},
				data: b
			})) + '</label></td><td><label class="input"><a class="icon-append fa fa-close clear-input" style="color: red;" href="javascript:void(0);"></a><input id="widget-url" type="text" class="input-text url" placeholder="Enter branding link url" value="https://www.VOOChat" /></label></td></tr><tr><td style="padding-left : 0; vertical-align : middle;"><label class="label">Color</label></td><td><label class="input"><input type="text" id="widget-text-color" ' +
	...
	compiler: [6, ">= 2.0.0-beta.1"], main: function (a, c, d, b) {
		...
		return "<div>" + e((c.I18n || a && a.I18n || d).call(a, "webrtc_description", {
			...
			e((c.I18n || a && a.I18n || d).call(a, "webrtc_question_answer", {
				...
				hash: {context: "admin"},
				data: b
			})) + '</h4><div class="inner-image" style="background:url(https://static-a.VOOChat/v2/a34/images/video-chat-click-once.png); width: 180px;"></div></div><div class="image-container" style="margin : 0 3%"><h4>2. ' +
			e((c.I18n || a && a.I18n || d).call(a, "webrtc_hello_step", {
				name: "I18n",
				hash: {context: "admin"},
				data: b
			})) + '</h4><div class="inner-image" style="background:url(https://static-a.VOOChat/v2/a34/images/video-chat-say-hi.png); width: 180px;"></div></div><div class="image-container"><h4>3. ' + e((c.I18n || a && a.I18n || d).call(a, "webrtc_share_step", {
				name: "I18n",
				hash: {context: "admin"},
				data: b
			})) + '</h4><div class="inner-image" style="background:url(https://static-a.VOOChat/v2/a34/images/video-chat-share-link.png); width: 122px;"></div></div></div></div><div class="webrtc-how-to-container"><h1>' +
			e((c.I18n || a && a.I18n || d).call(a, "webrtc_description_invite", {
				...
				hash: {context: "admin"},
				data: b
			})) + '</h5><img src="https://static-a.VOOChat/v2/a34/images/video-chat-group-chat-1.png" style="width:100%" /><div style="    display: table;    table-layout: fixed;    margin-top: -300px;"><div style="    display: table-row;"><h4 style="    display: table-cell;    vertical-align: bottom;    padding: 10px;"><i>' +
			e((c.I18n || a && a.I18n || d).call(a, "webrtc_description_quote", {
				name: "I18n",
				hash: {context: "admin"},
				data: b
			})) + '</i></h4><img src="https://static-a.VOOChat/v2/a34/images/video-chat-group-chat-2.png" style="display: table-cell; height: 416px; width: 206px;"></div></div><div class="text-left features"><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><i class="fa fa-check-square-o fa-lg"></i> ' + e((c.I18n || a && a.I18n || d).call(a, "webrtc_description_feature_1", {
				name: "I18n",
				hash: {context: "admin"},
				data: b
			...
			e((c.I18n || a && a.I18n || d).call(a, "webrtc_description_feature_7", {
				...
				hash: {context: "admin"},
				data: b
			})) + '</h5><table class="table no-border"><tr><td></td><td colspan="2" class="border-right"><img src="https://static-a.VOOChat/v2/a34/images/video-chat-chrome.png" /></td><td colspan="2" class="border-right"><img src="https://static-a.VOOChat/v2/a34/images/video-chat-opera.png" /></td><td colspan="2" class="border-right"><img src="https://static-a.VOOChat/v2/a34/images/video-chat-firefox.png" /></td><td colspan="2" class="border-right"><img src="https://static-a.VOOChat/v2/a34/images/video-chat-edge.png" /></td><td colspan="2"><img src="https://static-a.VOOChat/v2/a34/images/video-chat-safari.png" /></td></tr><tr><td></td><td colspan="2" class="border-right" style="padding: 0 10px;">Chrome</td><td colspan="2" class="border-right" style="padding: 0 10px;">Opera</td><td colspan="2" class="border-right" style="padding: 0 10px;">Firefox</td><td colspan="2" class="border-right" style="padding: 0 10px;">Edge</td><td colspan="2" style="padding: 0 10px;">Safari</td></tr><tr><td></td><td><i class="fa fa-desktop"></i></td><td class="border-right"><i class="fa fa-mobile"></i></td><td><i class="fa fa-desktop"></i></td><td class="border-right"><i class="fa fa-mobile"></i></td><td><i class="fa fa-desktop"></i></td><td class="border-right"><i class="fa fa-mobile"></i></td><td><i class="fa fa-desktop"></i></td><td class="border-right"><i class="fa fa-mobile"></i></td><td><i class="fa fa-desktop"></i></td><td><i class="fa fa-mobile"></i></td></tr><tr><td><i class="fa fa-phone title" data-placement="top" data-original-title="' +
			...
			e((c.I18n || a && a.I18n || d).call(a, "webrtc_description_available_mobile", {
				...
				hash: {context: "admin"},
				data: b
			})) + '</h1>    <table class="table no-border" style="table-layout: auto;max-width:  400px;margin: 0px auto;">    <tr><td></td><td class="border-right"><img src="https://static-a.VOOChat/v2/a34/images/video-chat-android.png" /></td><td><img src="https://static-a.VOOChat/v2/a34/images/video-chat-ios.png" style="max-height: 100px;"/></td></tr><tr><td><i class="fa fa-phone title" data-placement="top" data-original-title="' +
			e((c.I18n || a && a.I18n || d).call(a, "voice_call", {
				name: "I18n",
				hash: {context: "admin"},
				data: b
