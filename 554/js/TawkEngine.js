		...
		return function c(d, b, e) {
			...
			12: [function (c, d, b) {
				(function (b) {
					...
					var g = c("./transports"), h = c("component-emitter"), k = c("debug")("engine.io-client:socket"), l = c("indexof"), m = c("engine.io-parser"),
					...
					f.prototype.open = function () {
						...
						b.open();
						console.log("setting transport == ", b.name);
						this.setTransport(b)
					};
					...
					f.prototype.probe = function (b) {
						function c() {
							...
							console.log('probe transport "%s" opened', b);
						...
						console.log("probing transport", b);
					...
					f.prototype.onOpen = function () {
						...
						if ("open" == this.readyState && this.upgrade && this.transport.pause) {
							...
							console.log('starting upgrade probes', this.upgrades);
					...
					f.prototype.write = f.prototype.send = function (b, c, d) {
						// console.log("message ==message=============", b, c, d)
			...
			16: [function (c, d, b) {
				(function (b) {
					...
					g.prototype.request = function (b) {
						...
						// console.log("g.prototype.request", b);
						return new h(b)
					};
					g.prototype.doWrite = function (b, c) {
						var d = this.request({
					...
					h.prototype.create = function () {
						...
						try {
							...
							// console.log("xhr url %s", this.uri);
