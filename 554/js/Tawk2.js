Tawk.LiveMonitoringController = Ember.Controller.extend({
	...
	initInitialVisitors: function (a) {
		console.log("initInitialVisitors ==");
		var c = this;
...
Tawk.WhitelabelAddOnController = Ember.Controller.extend({
	...
	loadWhitelabelData: function (a) {
		...
		d.isActive || (c.settings.widget = {
			label: "Powered by *VOOChat*",
			url: "https://www.VOOChat",
			textColor: "#000000"
		},
			c.settings.email = {
				label: "No VOOChat live chat account? Create one for free here",
				url: "https://www.VOOChat"
			});
...
Tawk.AddOnsController = Ember.Controller.extend(Tawk.IAdminSubViewController, {
	...
	resetData: function () {
		...
		a.dkim1 = "tawk1._domainkey." +
			c[1];
		a.dkim2 = "tawk1._domainkey.mta.VOOChat";
		a.dkim3 = "tawk2._domainkey." + c[1];
		a.dkim4 = "tawk2._domainkey.mta.VOOChat";
...
var addOnList = {
	...
	"live-answering": {
		...
		betaCodeLink: "https://www.VOOChat/hire-chat-agents-1hr/",
	...
	webrtc: {
		...
		needBetaCode: !1,
		betaCodeLink: "https://www.VOOChat/updates/join-the-video-chat-beta/"
	},
	translation: {
		id: "translation",
...
Tawk.NewSetupWizardView = Ember.View.extend(Tawk.AdminBaseView, {
	...
	cmsLinks: [{value: "drupal", text: "Drupal", link: "https://github.com/tawk/tawk-drupal"}, {
		...
		link: "https://www.opencart.com/index.php?route=marketplace/extension/info&extension_id=16209&filter_search=VOOChat"
	},
		{
			value: "opencart2",
