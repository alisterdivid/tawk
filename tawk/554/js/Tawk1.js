...
Tawk.AgentsController =
	Ember.Controller.extend({
		...
		processAgents: function () {
			...
			this.agentsPending && (this.set("agentsProcessed", !1), a = this.agentsPending,console.log("agentsPending=================", a), this.set("agentsPending", null), a.forEach(function (a) {
				...
				console.log("Tawk.userController.user.resourceId===", Tawk.userController.user.resourceId);
...
Tawk.DashboardFeedsController = Ember.Controller.extend({
	feedsList: [], errorOnLoad: !1, loadFeeds: function () {
		...
		a.set("errorOnLoad", !1);
		$.ajax({
			url: "http://localhost:7000/tawk/feed", dataType: "json", success: function (c) {
