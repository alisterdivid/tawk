	...
	(function (w) {
		...
		try {
			...
			var E = "", F = 0, N = !1, L = !1, M = !1, K = null, x = null, ya, X, Y, va, fa, T = !0, k = {
					...
					restarted: !1,
					departments: []
				}, ra = {chat_sound: "https://static-v.tawk.to/a-v3-39/audio/chat_sound.mp3"},
				Ca = {chat_sound: "https://static-v.tawk.to/a-v3-39/audio/chat_sound.ogg"},
				Da = {chat_sound: "https://static-v.tawk.to/a-v3-39/audio/chat_sound.wav"},
				z = {chat_sound: "https://static-v.tawk.to/a-v3-39/audio/chat_sound.aac"};
			(function () {
				var a =
			...
			v.prototype.insertBeaconIframe = function () {
				N || this.insertStaticIframe("https://va.tawk.to/update/" + W.pageId + "/" + $_Tawk_WidgetId + "?v=" + (t.serverVersion ||
			...
			ba.prototype.handleError = function (a, n, f, q, c) {
				...
				if ("string" !== typeof n || -1 === n.indexOf("tawk.to") && -1 === n.indexOf("tawk.js")) return !1;
			...
			za.prototype.uploadFile =
				function (a, b, f, c, d) {
					var e,
						g = "https://upload.tawk.to/upload/visitor-chat/visitor?handle=" + a + "&visitorSessionId=" + t.sessionKey;
					this.uploads[a] = f;
					if (c) {
						var k;
						a += "-iframe";
			...
			var sa = S.extend({
				init: function () {
					...
					this.container.attachUserEventListener(b.viewHandler.clickEvent, function (b) {
						k.whiteLabel() || (k.brandingRedirect() ? h.open("https://ref.tawk.to/?utm_source=visitor-widget&utm_medium=link&utm_campaign=referral&utm_term=" + W.pageId) : a.container.getElementById("tawkToContent").style.display = "block")
					...
					this.container.attachUserEventListener(b.viewHandler.clickEvent, function (b) {
						a.container.getElementById("tawkToContent").style.display = "none";
						h.open("https://www.tawk.to/?utm_source=visitor-widget&utm_medium=link&utm_campaign=referral&utm_term=" + W.pageId)
			...
			D.prototype.popoutWidget = function () {
				this.indicator.hide();
				this.popoutWin && !this.popoutWin.closed && this.popoutWin.focus ? this.popoutWin.focus() : (this.popoutWin = h.open("https://tawk.to/chat/" + W.pageId + "/" + $_Tawk_WidgetId + "/?$_tawk_popout=true&$_tawk_sk=" + t.sessionKey + "&$_tawk_tk=" + t.transferKey + "&v=" + t.serverVersion, "Tawk", "height=500, width=450, resizable=yes, toolbar=no, location=no, menubar=no, personalbar=no"), t.chatWindowState("min"))
			};
			...
			Z.prototype.extractRegisterData = function (a) {
				a.wdgt && (a.wdgt.lc !== w.widgetSettings.lc && (this.waitingForLanguage = !0, m.insertScript("https://static-v.tawk.to/573/languages/" + a.wdgt.lc + ".js")), e.processSettings(a.wdgt));
			...
			Z.prototype.criticalRefresh = function (a, c, d) {
				var e = this, g = (new Date).getTime(),
					l = "https://embed.tawk.to/" + W.pageId + "/" + $_Tawk_WidgetId + "?refresh=true&";
